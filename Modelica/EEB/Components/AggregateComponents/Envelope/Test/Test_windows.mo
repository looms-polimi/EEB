...
model Test_windows
  ...
  Openings.InternalWindow_Closed_DoubleGlass internalWindow_SingleGlass(material_glass = EEB.Media.Materials.Glasses.Glass(), material_gas = EEB.Media.Materials.EnvelopeGases.Argon()) annotation(Placement(transformation(extent = {{-60, 40}, {-20, 80}})));
  Openings.ExtenallWindow_Closed_DoubleGlass extenallWindow_DoubleGlass(L = 2, H = 2, s = 0.02, material_glass = EEB.Media.Materials.Glasses.Glass(), material_gas = EEB.Media.Materials.EnvelopeGases.Argon()) annotation(Placement(transformation(extent = {{40, 40}, {80, 80}})));
equation
