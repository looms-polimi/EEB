...
model test4_CentrifugalPump
  ...
  Modelica.Blocks.Sources.Step step1( height = 0.2,offset = 0, startTime = 10) annotation(Placement(transformation(extent = {{-10, 34}, {2, 46}})));
  ...
  Modelica.Blocks.Sources.Step step2( height = 0.5, offset = 0.5,startTime = 1) annotation(Placement(transformation(extent = {{-86, 38}, {-74, 50}})));
