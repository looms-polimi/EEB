...
model OneRoom_ExtData_forTests
  ...
  Modelica.Blocks.Sources.CombiTimeTable Weather(columns = 2:4, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint, fileName = Modelica.Utilities.Files.loadResource("modelica://EEB/Resources/TestDEIB_123_July2015_7days_weather.txt"), tableName = "data", tableOnFile = true, verboseRead = false) annotation(
  ...
  Components.BaseComponents.Air.Pdrops.AirPdrop_Lin_NomPoint dp2 annotation(
...
equation
  ...
  connect(AHU.air_flange2, Room.air_flange1) annotation(
    Line(points = {{-30, -60}, {-24, -60}, {-24, -84}, {-10, -84}}, color = {0, 100, 150}));
  ...
  connect(Room.heatPort, room2wall.ss1) annotation(
    Line(points = {{-2, -75}, {-2, -39.5}, {-10, -39.5}, {-10, -14}}, color = {255, 0, 0}));
  connect(room2window.ss1, Room.heatPort) annotation(
    Line(points = {{2, -38}, {-2, -38}, {-2, -75}}, color = {255, 0, 0}));
  ...
  connect(Room.air_flange2, dp2.air_flange1) annotation(
    Line(points = {{6, -84}, {36, -84}, {36, -82}, {34, -82}}, color = {0, 100, 150}));
