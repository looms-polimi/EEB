within EEB.CaseStudies.DEIB.BuildingLevel.ThermalManagementStudy.RoomsWithLayeredWall.BaseClasses;
...
model BaseRoomThermal
  ...
  Modelica.Blocks.Interfaces.RealOutput Troom1 annotation(Placement(visible = true,transformation(extent = {{-366, 388}, {-346, 408}}, rotation = 0), iconTransformation(extent = {{94, 26}, {120, 52}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput Troom2 annotation(Placement(visible = true,transformation(extent = {{368, 384}, {388, 404}}, rotation = 0), iconTransformation(extent = {{94, -54}, {120, -28}}, rotation = 0)));
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false), graphics = {Rectangle(origin = {11.11, 0}, fillColor = {252, 233, 79}, fillPattern = FillPattern.Solid, extent = {{-111.11, 100}, {88.89, -100}}), Text(origin = {5.7358, -13.3333},fillColor = {0, 128, 255}, fillPattern = FillPattern.Solid, extent = {{-57.7358, 81.3333}, {44.2642, -40.6667}}, textString = "Room\nthermal")}));
end BaseRoomThermal;