within EEB.CaseStudies.DEIB.BuildingLevel.ThermalManagementStudy.Test;

model test1_Rooms "Differences between wall with or without layer"
  extends Icons.TestModel;
  EEB.CaseStudies.DEIB.BuildingLevel.ThermalManagementStudy.Rooms.RoomThermalSimplified RoomsThermalSimplified annotation(Placement(visible = true, transformation(origin = {43, -41}, extent = {{-25, -23}, {25, 23}}, rotation = 0)));
  ...
  RoomsWithLayeredWall.RoomThermal RoomThermalLayered annotation(
