within EEB.CaseStudies.DEIB.TemperatureControl.Thermal_equivalent.Rooms.BaseClasses;
...
model BaseRoomsThermalSimplified
  ...
  Modelica.Blocks.Interfaces.RealOutput Troom1 annotation(
    Placement(transformation(extent = {{-366, 388}, {-346, 408}}), iconTransformation(extent = {{74, 26}, {100, 52}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput Troom2 annotation(
    Placement(transformation(extent = {{368, 384}, {388, 404}}), iconTransformation(extent = {{74, -52}, {100, -26}})));
  ...
  Modelica.Blocks.Interfaces.RealInput Texternal annotation(
    Placement(transformation(extent = {{-700, 380}, {-660, 420}}), iconTransformation(extent = {{-110, 34}, {-84, 60}})));
  Modelica.Blocks.Interfaces.RealInput heater1 annotation(
    Placement(transformation(extent = {{-264, 428}, {-224, 468}}), iconTransformation(extent = {{-110, -14}, {-84, 12}})));
  ...
  Modelica.Blocks.Interfaces.RealInput heater2 annotation(
    Placement(transformation(extent = {{64, 432}, {104, 472}}), iconTransformation(extent = {{-110, -60}, {-84, -34}})));
...
equation
  ...
  annotation(
    Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-680, -480}, {680, 480}}), graphics),
    Icon(coordinateSystem(extent = {{-680, -480}, {680, 480}}, preserveAspectRatio = false), graphics = {Rectangle(extent = {{-100, 60}, {80, -60}}, lineColor = {0, 0, 0}, fillPattern = FillPattern.Solid, fillColor = {255, 128, 0}), Text(extent = {{-60, 20}, {46, -10}}, lineColor = {0, 0, 0}, fillColor = {0, 128, 255}, fillPattern = FillPattern.Solid, textString = "Rooms")}));
